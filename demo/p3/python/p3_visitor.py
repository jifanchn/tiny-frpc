...
def main():
    if len(sys.argv) < 4:
        print(f"Usage: {sys.argv[0]} <server_addr> <server_port> <visitor_name>")
        sys.exit(1)
    ...
    tunnel.start()
    print("Visitor started.")
    
    try:
        input_loop(tunnel, name)
