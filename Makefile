...
help:
	...
	@echo "  make test-bindings  - Run bindings tests (Python + Node.js + Rust)"
	@echo "  make python         - Run Python bindings tests"
	@echo "  make nodejs         - Run Node.js bindings tests"
	@echo "  make rust           - Run Rust bindings tests"
